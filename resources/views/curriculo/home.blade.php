...
<html>
    ...
    <body>
        ...
        <div id='jobs' class='container trabalhos'>
            ...
            <div class='row'>
                <div class='col-lg imgs'>
                    <img class='img1' src="{{asset('/storage/imgs/gincana2.png')}}">
            ...
            <div class='row'>
                <div class='col-lg imgs order-lg-2 imgs'>
                    <img class='img1' src="{{asset('/storage/imgs/educa2.png')}}">
            ...
            <div class='row'>
                <div class='col-lg imgs'>
                    <img class='img1' src="{{asset('/storage/imgs/bbts2.png')}}">
        ...
        <div class="container">
            ...
            <h5>Aqui estão as empresas que já trabalhei.</h5>
